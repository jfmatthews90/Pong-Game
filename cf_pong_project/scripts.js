...
function drawEverything() {
	...
	drawNet();
	//left player paddle
	colorRect(canvas.width-790, paddle1Y, PADDLE_THICKNESS, 100, 'orange');
	//right computer paddle
	colorRect(canvas.width-20, paddle2Y, PADDLE_THICKNESS, 100, 'orange');
	//ball
	colorCircle(ballX, ballY, 10, 'darkred');
	//scoreboard
